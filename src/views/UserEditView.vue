<template>
    <div class="container">
        <h1>This is an edit user page</h1> 
        ...
        <form id="editUserForm" v-if="user" @submit.prevent="updateUser">
          ...
          <div class="mb-3">
            ...
            <input v-model="user.userRole" type="text" step="0.01" class="form-control text-center" id="editUserRole" required>
          </div>
          <div class="mb-3">
            <label for="editUserEmailAdd" class="form-label">Email Address</label>
            <input v-model="user.emailAdd" type="email" step="0.01" class="form-control text-center" id="editUserEmailAdd" required>
          </div>
          <div class="mb-3">
            <label for="editUserPass" class="form-label">User Password</label>
            <input v-model="user.userPass" type="text" step="0.01" class="form-control text-center" id="editUserPass" required>
          </div>
          <div class="mb-3">
            <label for="editUserProfile" class="form-label">Profile Pic</label>
            <input v-model="user.userProfile" type="url" step="0.01" class="form-control text-center" id="editUserProfile" required>
          </div>
